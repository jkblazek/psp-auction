...
def create_seller_shared_buyer_network(num_buyers, num_sellers):
    ...
    return G_seller_buyer, G_buyer_buyer, seller_buyer_connections
...
def plot_clustered_network_and_bids_with_sellers_only_legend(G_seller_buyer, G_buyer_buyer, price_history, seller_buyer_connections):
    ...
    for idx, (seller_id, buyers) in enumerate(seller_buyer_connections.items()):
        ...
        nx.draw_networkx_nodes(G_seller_buyer, pos, nodelist=buyer_ids, node_color=[color] * len(buyer_ids), node_size=300)
    ...
    nx.draw_networkx_edges(G_buyer_buyer, pos, edgelist=dotted_edges, style='dotted', edge_color='gray', width=1)
...
def main_psp_with_seller_ou_processes(iterations=100):
    ...
    for iteration in range(iterations):
        ...
        G_seller_buyer, G_buyer_buyer, seller_buyer_connections = create_seller_shared_buyer_network(len(buyers), len(sellers))
...
main_psp_with_seller_ou_processes(iterations=100)